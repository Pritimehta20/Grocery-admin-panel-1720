...
const UploadSubCategory = ({close,fetchData}) => {
    ...
    console.log("all categor",allCategory)
  ...
  return (
   <section className='fixed top-0 right-0 bottom-0 left-0 bg-neutral-800 black/70 z-50 flex items-center justify-center p-4'>
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='flex flex-col lg:flex-row items-center gap-3'>
                            ...
                            <label htmlFor='uploadSubCategoryImage'>
                                <div className='px-4 py-1 border border-blue-400 text-blue-400 rounded hover:bg-blue-700 hover:text-white cursor-pointer  '>
                                    Upload Image
                                </div>
                                <input 
                                    type='file'
